...
public class PaymentServiceImpl implements PaymentService {
  ...
  public Long savePayment(PaymentDto paymentDto) {
    ...
    Optional<Bidding> optionalBidding = biddingRepository.findById(
      paymentDto.getBno()
    );
  ...
  @Override
  public List<Long> getPaymentMid(Long mid) {
    List<Long> payments = paymentRepository.findByMemberMid(mid);

    log.info("paymentService payments : {}", payments);
    return payments;
  }
}
